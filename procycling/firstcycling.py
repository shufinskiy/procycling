...
class FirstCycling(object):
    ...
    @staticmethod
    def read_race_hist_general(race_id: Union[int, List[int]]) -> pd.DataFrame:
    ...
    @staticmethod
    def read_race_hist_yby(race_id: int, convert_to_sec: bool = False) -> pd.DataFrame:
    ...
    @staticmethod
    def read_race_hist_victories(race_id: int) -> Optional[pd.DataFrame]:
    ...
    @staticmethod
    def read_race_hist_stages(race_id: int) -> Optional[pd.DataFrame]:
    ...
    @staticmethod
    def read_race_hist_young_old_win(race_id: int) -> Optional[pd.DataFrame]:
...
if __name__ == '__main__':
    ...
    hist1 = cycling.read_race_hist_general(1)
    hist2 = cycling.read_race_hist_young_old_win(1)
    hist3 = cycling.read_race_hist_yby(1, convert_to_sec=False)
    hist4 = cycling.read_race_hist_victories(1)
    hist5 = cycling.read_race_hist_stages(1)
    a = 1
